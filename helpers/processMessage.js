...
function addMenuGetStarted() {
    messenger.setPersistentMenu("511973805856834", payload.menuItems, function (err, body) {
        if (err) return console.error("Error en el menu: ", err)
        console.log("Exito -->", body);
    });

    messenger.sendThreadSettingsMessage("511973805856834", payload.getStarted, function (err, body) {
